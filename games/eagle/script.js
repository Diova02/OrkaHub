...
// No momento em que o jogo inicia (ex: função startCountdown ou similar)
function hideUIForGame() {
    if (toolbar) toolbar.classList.add('hidden');
}

// No momento em que o jogo acaba e volta para o menu (ex: função endGame ou showMenu)
function showUIAfterGame() {
