export const UPGRADES_DEF = {
    damage: { name: "Dano", icon: "⚔️", desc: "+ Dano Base", baseCost: 15, val: 10, inc: 4 },
    speed:  { name: "Velocidade", icon: "⚡", desc: "- Delay Tiro", baseCost: 20, val: 50, dec: 3, min: 4 },
...
export const ARTIFACTS_DEF = {
    ...
    knockback: { name: "Repulsão", icon: "🥊", color: "#ffffff", maxLvl: 5, desc: "Empurre inimigos atingidos.", upgDesc: "+ Força da repulsão.", force: 10 },
...
export const SKINS_CONFIG = {
    'player': { name: 'Padrão', price: 0, path: '../../assets/imagens/firewall/player.png' },
    'player_red': { name: 'Rubi', price: 10, path: '../../assets/imagens/firewall/player_red.png' },
    'player_gray': { name: 'Cinza', price: 10, path: '../../assets/imagens/firewall/player_gray.png' }
};

// Esse objeto deve ser salvo no localStorage futuramente
export let userInventory = {
    ownedSkins: ['player','player_red','player_gray'], // O jogador já começa com a padrão
    currentSkin: 'player'
};